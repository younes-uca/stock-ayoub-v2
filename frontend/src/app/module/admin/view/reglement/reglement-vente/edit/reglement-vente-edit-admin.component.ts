...
export class ReglementVenteEditAdminComponent extends AbstractEditController<ReglementVenteDto, ReglementVenteCriteria, ReglementVenteAdminService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateReglement = this.reglementVenteService.format(this.item.dateReglement);
    }
