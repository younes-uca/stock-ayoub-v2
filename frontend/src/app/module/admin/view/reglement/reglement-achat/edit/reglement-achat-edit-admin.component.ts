...
export class ReglementAchatEditAdminComponent extends AbstractEditController<ReglementAchatDto, ReglementAchatCriteria, ReglementAchatAdminService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateReglement = this.reglementAchatService.format(this.item.dateReglement);
    }
