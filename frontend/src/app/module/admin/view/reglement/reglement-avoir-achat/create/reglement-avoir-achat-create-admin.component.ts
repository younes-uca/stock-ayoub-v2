...
@Component({
  selector: 'app-reglement-avoir-achat-create-admin',
  templateUrl: './reglement-avoir-achat-create-admin.component.html'
})
export class ReglementAvoirAchatCreateAdminComponent extends AbstractCreateController<ReglementAvoirAchatDto, ReglementAvoirAchatCriteria, ReglementAvoirAchatAdminService>  implements OnInit {
