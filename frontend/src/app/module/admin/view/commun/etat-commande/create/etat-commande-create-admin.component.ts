...
@Component({
  selector: 'app-etat-commande-create-admin',
  templateUrl: './etat-commande-create-admin.component.html'
})
export class EtatCommandeCreateAdminComponent extends AbstractCreateController<EtatCommandeDto, EtatCommandeCriteria, EtatCommandeAdminService>  implements OnInit {
