...
export class CommandeEditAdminComponent extends AbstractEditController<CommandeDto, CommandeCriteria, CommandeAdminService>   implements OnInit {
   ...
   public addCommandeItems() {
    ...
    private validateCommandeItemsProduit(){
    ...
    private validateCommandeItemsQuantite(){
    ...
    private validateCommandeItemsPrixUnitaireHt(){
    ...
    private validateCommandeItemsPrixUnitaireTtc(){
    ...
    private validateCommandeItemsRemise(){
    ...
    private validateCommandeItemsMontantHt(){
    ...
    private validateCommandeItemsMontantTtc(){
