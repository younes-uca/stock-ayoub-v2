...
@Component({
  selector: 'app-entree-produit-item-create-admin',
  templateUrl: './entree-produit-item-create-admin.component.html'
})
export class EntreeProduitItemCreateAdminComponent extends AbstractCreateController<EntreeProduitItemDto, EntreeProduitItemCriteria, EntreeProduitItemAdminService>  implements OnInit {
