...
export class VenteCreateAdminComponent extends AbstractCreateController<VenteDto, VenteCriteria, VenteAdminService>  implements OnInit {
   ...
   private _validVenteMontantTtc = true;
    ...
    public validateVenteItemsPrixUnitaireHt(){
    ...
    public validateVenteItemsMontantHt(){
    ...
    public validateAvoirVentesBarCode(){
    ...
    public validateAvoirVentesEntrepriseSociete(){
    ...
    public validateAvoirVentesCodeAvoirVente(){
    ...
    public validateAvoirVentesNumeroFactureAvoirVente(){
    ...
    public validateAvoirVentesDateFactureAvoirVente(){
    ...
    public validateAvoirVentesClient(){
    ...
    public validateAvoirVentesMontantTtc(){
    ...
    public validateReglementVentesReference(){
    ...
    public validateReglementVentesMontant(){
