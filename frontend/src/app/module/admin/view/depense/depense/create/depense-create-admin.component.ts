...
@Component({
  selector: 'app-depense-create-admin',
  templateUrl: './depense-create-admin.component.html'
})
export class DepenseCreateAdminComponent extends AbstractCreateController<DepenseDto, DepenseCriteria, DepenseAdminService>  implements OnInit {
