...
public class BonPourItemDto  extends AuditBaseDto {
    ...
    private BonPourDto bonPour ;



    public BonPourItemDto(){
        super();
    }
    ...
    public BonPourDto getBonPour(){
        return this.bonPour;
    }

    public void setBonPour(BonPourDto bonPour){
