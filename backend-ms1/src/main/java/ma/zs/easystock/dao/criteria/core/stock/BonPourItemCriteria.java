...
public class BonPourItemCriteria extends  BaseCriteria  {
    ...
    private BonPourCriteria bonPour ;
    private List<BonPourCriteria> bonPours ;


    public BonPourItemCriteria(){}
    ...
    public BonPourCriteria getBonPour(){
        return this.bonPour;
    }

    public void setBonPour(BonPourCriteria bonPour){
        this.bonPour = bonPour;
    }
    public List<BonPourCriteria> getBonPours(){
        return this.bonPours;
    }

    public void setBonPours(List<BonPourCriteria> bonPours){
        this.bonPours = bonPours;
    }
}
