...
@SequenceGenerator(name="reglement_avoir_vente_seq",sequenceName="reglement_avoir_vente_seq",allocationSize=1, initialValue = 1)
public class ReglementAvoirVente   extends AuditBusinessObject     {
